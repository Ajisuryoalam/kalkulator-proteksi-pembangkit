...
// IEC 60255-8 — model thermal replica motor (single time constant)
// M = I / Ith (kelipatan arus thermal setting), theta0 = kondisi thermal awal (0-1),
// tauMinutes = konstanta waktu thermal (menit). Mengembalikan waktu trip dalam detik.
