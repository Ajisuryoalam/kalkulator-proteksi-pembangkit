...
export const EQUIP = {
  ...
  grading:{
    label:'Grading Motor SEL-749M (49T)', dev:'SEL Appendix F', dot:10, custom:true
  },
...
export const ORDER = ['generator','trafo','busbar','feeder','kabel','motor','koordinasi','kha','konduktor','gardu','grading'];
